...
// Table from Github: https://github.com/Zer0Mem0ry/CRC32
...
unsigned int anticheat::error_checking::crc_crypt(error_checking::crc_buffer pData, error_checking::crc_size iLen)
{
...
anticheat::error_checking::crc_buffer anticheat::error_checking::crc_allocate(error_checking::crc_size size)
{
	return reinterpret_cast<error_checking::crc_buffer>(calloc(size, 0));
}

void anticheat::error_checking::crc_deallocate(error_checking::crc_buffer buffer)
{
	free(buffer);
}
